/*
     ...
     Version:    Technology: Mac OS X/CarbonLib 1.4
...
/*
    ...
    kEventMouseMoved
        -->     kEventParamMouseLocation    typeQDPoint
        -->     kEventParamMouseDelta       typeQDPoint (X Only)
        -->     kEventParamKeyModifiers     typeUInt32
 ...
 */
   ...
   * is available in Mac OS X only. This event is used to manage
   * ownership of the cursor.  You should only change the cursor if you
   * receive this event; otherwise, someone else needed to adjust the
   * cursor and handled the event (e.g., a TSM Input Method when the
   * mouse is over an inline input region).
   */
enum {
...
enum {
  ...
  /*
   * Indicates that the proximity of the pen has changed on a tablet.
   * (Mac OS X only)
   */
